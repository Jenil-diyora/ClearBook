    ...
    return (
        <div className="form-container">
            <div className="card form-card">
                <h1 className="form-header-title">{ contactId === newUrl ? "Add New" : "Update"} Contact</h1>
                <p className="form-header-subtitle">Provide details for the customer contact information.</p>
                <Form 
                    data={data}
                    schema={schema}
                    onError={setErrors}
                ...
                >
                    ...
                    <div className="form-actions">
                        <button className="btn btn-primary mt-2">Save Contact</button>
                    </div>
                </Form>
            </div>
        </div>
