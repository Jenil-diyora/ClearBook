    ...
    return (
        <div className="form-container">
            <div className="card form-card">
                <div className="row" style={{ alignItems: 'center', marginBottom: '24px', borderBottom: '1px solid var(--color-border)', paddingBottom: '16px' }}>
                    <div className="col-8">
                        <h1 className="form-header-title" style={{ margin: 0 }}>{invoiceType}</h1>
                        <p className="form-header-subtitle" style={{ margin: 0 }}>Create or edit invoice details and line items.</p>
                    </div>
                ...
                >
                    ...
                    <div className="form-actions">
                        <Button name="published" loading={loading} text={data.status === "PUBLISHED" && invoiceId !== newUrl ? "Save" : "Publish" } styles="btn btn-primary" />
                        {data.status === "PUBLISHED" && invoiceId !== newUrl
                            ? <Link to="/invoices/" className="btn btn-secondary">Return to Invoices</Link>
                            : <Button name="draft" loading={null} text="Save Draft" styles="btn btn-secondary" /> }
                    </div>
                </Form>
            </div>
        </div>
